...
-- Bow primary ability
SaturnAutoBowShot = WeaponAbility:new()

function SaturnAutoBowShot:init()
...
function SaturnAutoBowShot:update(dt, fireMode, shiftHeld)
...
function SaturnAutoBowShot:uninit()
  self:reset()
end

function SaturnAutoBowShot:reset()
  animator.setGlobalTag("drawFrame", "0")
  self.weapon:setStance(self.stances.idle)
end

function SaturnAutoBowShot:draw()
...
function SaturnAutoBowShot:fire()
...
function SaturnAutoBowShot:perfectTiming()
  return self.drawTime > self.powerProjectileTime[1] and self.drawTime < self.powerProjectileTime[2]
end

function SaturnAutoBowShot:currentProjectileParameters()

...
KyterranultraMeleeCombo = WeaponAbility:new()

function KyterranultraMeleeCombo:init()
  self.comboStep = 1
...
function KyterranultraMeleeCombo:update(dt, fireMode, shiftHeld)
...
-- State: windup
function KyterranultraMeleeCombo:windup()
...
function KyterranultraMeleeCombo:wait()
...
function KyterranultraMeleeCombo:preslash()
...
-- State: fire
function KyterranultraMeleeCombo:fire()
...
function KyterranultraMeleeCombo:shouldActivate()
...
function KyterranultraMeleeCombo:readyFlash()
  animator.setGlobalTag("bladeDirectives", self.flashDirectives)
  self.flashTimer = self.flashTime
end

function KyterranultraMeleeCombo:computeDamageAndCooldowns()
  local attackTimes = {}
...
function KyterranultraMeleeCombo:uninit()

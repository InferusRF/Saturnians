...
function build(directory, config, parameters, level, seed)
  ...
  if config.tooltipKind ~= "base" then
	...
	config.tooltipFields.tileDamageLabel = util.round(1 / (config.primaryAbility.tileDamage or 1.0), 1)
	config.tooltipFields.tileDamageRateLabel = util.round(1 * (config.primaryAbility.tileDamageRate or 1.0), 1)
